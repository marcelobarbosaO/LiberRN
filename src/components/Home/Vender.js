...
class Vender extends Component {
    ...
    _loadItemsVenda() {
        ...
        axios.post('http://liberapp.com.br/api/publicacoes', { id: perf.server_response.server_id, filtro: 3, filtro_ativado:this.state.filtro_ativado, cidade_id: this.state.cidade_id })
            .then((response) => {
